...
@InputType()
class BillboardUpdateInput {
  @ApiProperty({
    required: false,
    type: () => BookingUpdateManyWithoutBillboardsInput,
  })
  @ValidateNested()
  @Type(() => BookingUpdateManyWithoutBillboardsInput)
  @IsOptional()
  @Field(() => BookingUpdateManyWithoutBillboardsInput, {
    nullable: true,
  })
...
export { BillboardUpdateInput as BillboardUpdateInput };
