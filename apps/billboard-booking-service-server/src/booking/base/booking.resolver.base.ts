...
export class BookingResolverBase {
  ...
  async createBooking(
    ...
    return await this.service.createBooking({
      ...
      data: {
        ...
        billboard: args.data.billboard
          ? {
              connect: args.data.billboard,
            }
          : undefined,
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => Billboard, {
    nullable: true,
    name: "billboard",
  })
  @nestAccessControl.UseRoles({
  ...
  async getBillboard(
    ...
    const result = await this.service.getBillboard(parent.id);
  ...
  async getImage(@graphql.Parent() parent: Booking): Promise<Image | null> {
